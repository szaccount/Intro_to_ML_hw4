...
# question 1.d
# for batch_size in range(2, 20, 2):
#     print(f"Trianing network with mini_batch_size={batch_size}")
#     net = backprop_network.Network([784, 450, 10])
#     net.SGD(training_data.copy(), epochs=30, mini_batch_size=batch_size, learning_rate=0.1, test_data=test_data.copy(), statistics=False)
#     print(f"Ended\n\n")